...
public class ConnectFourJSpotBoard extends JPanel implements SpotBoard {

	private static final int DEFAULT_SCREEN_WIDTH = 500;
	private static final int DEFAULT_SCREEN_HEIGHT = 500;
	private static final Color DEFAULT_BACKGROUND_LIGHT = new Color(0.9f, 0.9f, 0.9f);
	private static final Color DEFAULT_BACKGROUND_DARK = new Color(0.4f, 0.4f, 0.4f);
	private static final Color DEFAULT_SPOT_COLOR = Color.BLACK;
	private static final Color DEFAULT_HIGHLIGHT_COLOR = Color.YELLOW;

	private Spot[][] _spots;
	
	public ConnectFourJSpotBoard(int width, int height) {
